...
public class FixedFlowInputRuntimeBak extends PTransform<PBegin, PCollection<IndexedRecord>> {

    private final FixedFlowInputConfiguration configuration;

    public FixedFlowInputRuntimeBak(@Option("configuration") final FixedFlowInputConfiguration configuration) {
