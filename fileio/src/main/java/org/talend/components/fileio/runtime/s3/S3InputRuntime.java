...
//
// ============================================================================
package org.talend.components.fileio.runtime.s3;
...
public class S3InputRuntime extends PTransform<PBegin, PCollection<IndexedRecord>>
    ...
    public PCollection<IndexedRecord> expand(PBegin in) {
        ...
        case CSV:
            ...
            rf = new SimpleRecordFormatCsvIO(doAs, path, limit, dataset.getRecordDelimiter(), dataset.getFieldDelimiter(),
                    dataset.getEncoding(), dataset.getHeaderLine(), dataset.getTextEnclosureCharacter(),
                    dataset.getEscapeCharacter());
            break;
        ...
        case EXCEL:
            ...
            rf = new SimpleRecordFormatExcelIO(doAs, path, overwrite, limit, mergeOutput, ds.getEncoding(), ds.getSheetName(),
                    ds.getHeaderLine(), ds.getFooterLine(), ds.getExcelFormat());
            break;
        }
