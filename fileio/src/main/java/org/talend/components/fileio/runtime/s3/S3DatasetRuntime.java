...
public class S3DatasetRuntime implements IS3DatasetRuntime {
    ...
    // getSample is not a good name for the data set interface, as sometimes, it is used to fetch all data in data set definition,
    // not sample
    // Or if it's a good name and only for get sample, for the rest api to get all data in data set should not call this method,
    // should call another interface for
    // fetch all data.
    @Override
