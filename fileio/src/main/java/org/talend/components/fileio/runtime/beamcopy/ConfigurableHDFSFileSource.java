...
public class ConfigurableHDFSFileSource<K, V> extends BoundedSource<KV<K, V>> {
    ...
    @Override
    public List<? extends BoundedSource<KV<K, V>>> split(long desiredBundleSizeBytes, PipelineOptions options) throws Exception {
    ...
    protected List<InputSplit> computeSplits(long desiredBundleSizeBytes)
