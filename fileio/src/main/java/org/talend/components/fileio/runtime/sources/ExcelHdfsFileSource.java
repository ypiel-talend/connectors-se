...
//
// ============================================================================
package org.talend.components.fileio.runtime.sources;
...
public class ExcelHdfsFileSource extends FileSourceBase<Void, IndexedRecord, ExcelHdfsFileSource> {
    ...
    private ExcelHdfsFileSource(UgiDoAs doAs, String filepattern, LazyAvroCoder<IndexedRecord> lac, int limit, String encoding,
            String sheetName, long header, long footer, String excelFormat, ExtraHadoopConfiguration extraConfig,
    ...
    private ExcelHdfsFileSource(UgiDoAs doAs, String filepattern, LazyAvroCoder<IndexedRecord> lac,
    ...
    public static ExcelHdfsFileSource of(UgiDoAs doAs, String filepattern, LazyAvroCoder<IndexedRecord> lac, int limit,
            String encoding, String sheetName, long header, long footer, String excelFormat) {
        return new ExcelHdfsFileSource(doAs, filepattern, lac, limit, encoding, sheetName, header, footer, excelFormat,
                new ExtraHadoopConfiguration(), null);
    }

    // call back by framework only, we call construct to set the parameter in ExtraHadoopConfiguration : extraConfig object before
    // it
    @Override
    protected ExcelHdfsFileSource createSourceForSplit(SerializableSplit serializableSplit) {
        ExcelHdfsFileSource source = new ExcelHdfsFileSource(doAs, filepattern, lac, getExtraHadoopConfiguration(),
                serializableSplit);
