...
import org.talend.components.fileio.runtime.sinks.UgiFileSinkBase;
import org.talend.components.fileio.runtime.sinks.UnboundedWrite;
import org.talend.components.fileio.runtime.sources.CsvHdfsFileSource;
...
public class SimpleRecordFormatCsvIO extends SimpleRecordFormatBase {
    ...
    public SimpleRecordFormatCsvIO(UgiDoAs doAs, String path, int limit, String recordDelimiter, String fieldDelimiter,
            String encoding, long header, String textEnclosure, String escapeChar) {
    ...
    public PCollection<IndexedRecord> read(PBegin in) {
        ...
        if (path.startsWith("gs://")) {
            ...
            CsvHdfsFileSource source = CsvHdfsFileSource.of(doAs, path, recordDelimiter, encoding, header, textEnclosure,
                    escapeChar);
        ...
        PCollection<IndexedRecord> pc3 = pc2
                .apply(ParDo.of(new ExtractCsvRecord<>(fieldDelimiter.charAt(0), isGSFileSystem, encoding, te, ec)));
        return pc3;
    }
    ...
    public static class ExtractCsvRecord<T> extends DoFn<T, IndexedRecord> {
        ...
        public ExtractCsvRecord(char fieldDelimiter, boolean isGSFileSystem, String encoding, Character textEnclosure,
