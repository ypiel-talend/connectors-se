...
public class SimpleRecordFormatExcelIO extends SimpleRecordFormatBase {
    ...
    public SimpleRecordFormatExcelIO(UgiDoAs doAs, String path, boolean overwrite, int limit, boolean mergeOutput,
            String encoding, String sheetName, long header, long footer, ExcelFormat excelFormat) {
    ...
    public PCollection<IndexedRecord> read(PBegin in) {
        ...
        ExcelHdfsFileSource source = ExcelHdfsFileSource.of(doAs, path, lac, limit, encoding, sheetName, header, footer,
                excelFormat.name());
