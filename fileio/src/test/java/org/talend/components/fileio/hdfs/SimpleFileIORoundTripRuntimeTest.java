...
public class SimpleFileIORoundTripRuntimeTest {
    ...
    protected static List<IndexedRecord> runRoundTripPipelines(BeamDirectTestResource beam, List<IndexedRecord> initialData,
            SimpleFileIOOutputConfig outputConfig, SimpleFileIODataSet dataset) {
        // Create the runtimes.
    ...
    public void testBasicDefaults() throws IOException {
        ...
        SimpleFileIODataSet dataset = outputConfig.getDataset();

        List<IndexedRecord> actual = runRoundTripPipelines(beam, rs.getAllData(), outputConfig, dataset);
        ...
        mini.assertReadFile(mini.getLocalFs(), fileSpec,
                rewriteRecordsAsCsvLines(expected, dataset.getRecordDelimiterValue(), dataset.getFieldDelimiterValue()));
    }
    ...
    public void testCsvWithDelimiters() throws IOException {
        ...
        outputConfig.getDataset().setPath(fileSpec);
        outputConfig.getDataset().setRecordDelimiter(RecordDelimiterType.OTHER);
        outputConfig.getDataset().setSpecificRecordDelimiter("---");
        outputConfig.getDataset().setFieldDelimiter(FieldDelimiterType.OTHER);
        outputConfig.getDataset().setSpecificFieldDelimiter("|");
