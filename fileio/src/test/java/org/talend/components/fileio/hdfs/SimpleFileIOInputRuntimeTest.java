...
import org.talend.components.fileio.CsvExample;
...
public class SimpleFileIOInputRuntimeTest {
    ...
    public void testBasicCSV_changeSeparator() throws IOException, URISyntaxException {
        ...
        dataset.setRecordDelimiter(RecordDelimiterType.CRLF);
        dataset.setFieldDelimiter(FieldDelimiterType.SPACE);
    ...
    public void testBasicCSV_changeSeparator2() throws IOException, URISyntaxException {
        ...
        dataset.setRecordDelimiter(RecordDelimiterType.CR);
        dataset.setFieldDelimiter(FieldDelimiterType.TABULATION);
    ...
    public void testBasicCsvCustomDelimiters() throws IOException, URISyntaxException {
        ...
        dataset.setFormat(SimpleFileIOFormat.CSV);
        dataset.setPath(fileSpec);
        dataset.setRecordDelimiter(RecordDelimiterType.OTHER);
        dataset.setSpecificRecordDelimiter("---");
        dataset.setFieldDelimiter(FieldDelimiterType.OTHER);
        dataset.setSpecificFieldDelimiter("|");
     ...
     * String fileSpecOutput = mini.getLocalFs().getUri().resolve(new Path(mini.newFolder().toString(),
     * "output.csv").toUri()).toString();
     * 
     * // Configure the component.
     * SimpleFileIODataSet dataset = createSimpleFileIODataSet();
     * dataset.setFormat(SimpleFileIOFormat.PARQUET);
