...
public class SplitUtil {
    ...
    public static List<String> getQueries4Split(final DocDBInputMapperConfiguration configuration,
            final DocDBService service,
            final int splitCount, final DocDBConnectionService conn) {
    ...
    public static long getEstimatedSizeBytes(final DocDBInputMapperConfiguration configuration,
            final DocDBService service, final DocDBConnectionService conn) {
        DocDBDataSet dataset = configuration.getDataSet();
        DocDBDataStore datastore = dataset.getDataStore();
