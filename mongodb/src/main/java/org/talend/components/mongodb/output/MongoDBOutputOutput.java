...
public class MongoDBOutputOutput implements Serializable {

    private final MongoDBOutputOutputConfiguration configuration;

    private final MongoDBService service;

    public MongoDBOutputOutput(@Option("configuration") final MongoDBOutputOutputConfiguration configuration,
