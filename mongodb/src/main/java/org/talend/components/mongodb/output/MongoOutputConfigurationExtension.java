...
@Data
@GridLayouts({
        @GridLayout(value = { @GridLayout.Row({ "setWriteConcern" }), @GridLayout.Row({ "writeConcern" }),
...
public class MongoOutputConfigurationExtension implements Serializable {
    ...
    private MongoDBOutputConfiguration.WriteConcern writeConcern;
    ...
    private MongoDBOutputConfiguration.BulkWriteType bulkWriteType;
    ...
    @DefaultValue("INSERT")
    private MongoDBOutputConfiguration.ActionOnData actionOnData;
