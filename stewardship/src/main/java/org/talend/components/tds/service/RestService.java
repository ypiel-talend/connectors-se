 ...
 */
package org.talend.components.tds.service;
...
import org.talend.components.tds.configuration.Datastore;
import org.talend.components.tds.configuration.Param;
import org.talend.components.tds.configuration.RequestConfig;
import org.talend.components.tds.configuration.auth.Authentication;
import org.talend.components.tds.configuration.auth.Authorization;
import org.talend.components.tds.service.client.Body;
import org.talend.components.tds.service.client.Client;
...
public class RestService {
    ...
    private final static String PARAMETERS_SUBSTITUTOR_PREFIX = System
            .getProperty("org.talend.components.tds.parameters_substitutor_prefix", "{");

    private final static String PARAMETERS_SUBSTITUTOR_SUFFIX = System
            .getProperty("org.talend.components.tds.parameters_substitutor_suffix", "}");

    private final static String BODY_SUBSTITUTOR_PREFIX = System.getProperty("org.talend.components.tds.body_substitutor_prefix",
            "${");

    private final static String BODY_SUBSTITUTOR_SUFFIX = System.getProperty("org.talend.components.tds.body_substitutor_suffix",
            "}");
