...
@PartitionMapper(name = "CompanyComponent1")
@Documentation("TODO fill the documentation for this mapper")
public class CompanyComponent1Mapper implements Serializable {
    private final CompanyComponent1MapperConfiguration configuration;
    private final CompanyComponentService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public CompanyComponent1Mapper(@Option("configuration") final CompanyComponent1MapperConfiguration configuration,
    ...
    @Split
    public List<CompanyComponent1Mapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 CompanyComponent1Mapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public CompanyComponent1Source createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new CompanyComponent1Source(configuration, service, recordBuilderFactory);
    }
}