...
public class CompanyComponent1Source implements Serializable {
    private final CompanyComponent1MapperConfiguration configuration;
    private final CompanyComponentService service;
    private final RecordBuilderFactory builderFactory;

    public CompanyComponent1Source(@Option("configuration") final CompanyComponent1MapperConfiguration configuration,
